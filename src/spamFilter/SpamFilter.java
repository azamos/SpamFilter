...
public class SpamFilter {
    ...
    public static int m = (int) Math.ceil(1.500 * (-MAX_SPAM_ADDRESS_COUNT / (ln2 * ln2)) * Math.log(ERROR_THRESHOLD));
    ...
    private void set_k_hash_functions() {
        for (int i = 0; i < k; i++) {
             ...
             * overflow
             */
            hashFunctions[i] = str -> Math.floorMod(h1.apply(str) + balls * h2.apply(str), m);
        }
    }
